                                ...
                                <div class="product-item-container">
                                    <div class="left-block">
                                        <div class="product-image-container lazy second_img ">
                                            <img data-src="<?= UP.$product->Image ?>" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"   class="img-responsive" />
                                            <img data-src="<?= UP.$product->Image ?>" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"  class="img_0 img-responsive" />
                                        </div>
                                    </div>
